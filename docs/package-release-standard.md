...
This is the common Kumwe package release contract for maintained packages.
...
`release-verified` and downstream adoption decisions under the package's release contract.
